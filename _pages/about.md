...
My name is XU (徐) Yong (勇). I grew up in Xinyang, Henan, China. 🗣️ My mother tongue is the Xinyang dialect. I navigate between  Mandarin and English, and possess a surviving-level proficiency in German. <!--Python 💻 is now my native  language, through which I can express myself well. --> I earned my PhD 🎓 from [Bonn University](https://www.pi.uni-bonn.de/en/homepage?set_language=en) in October 2022, was previously a research associate at [Mainz University](https://www.mitp.uni-mainz.de/), and currently postdoctoral resercher at [McGill University](https://www.physics.mcgill.ca).   
...
I work in theoretical particle cosmology, connecting quantum field theory with the dynamics of the early Universe. My research develops predictive frameworks to uncover the microphysics of the pre-BBN epoch through gravitational waves, dark matter, and precision cosmological observables.

[Inspire HEP](https://inspirehep.net/authors/1737900?ui-citation-summary=true)

[Google Scholar](https://scholar.google.com/citations?user=HPUJB4QAAAAJ&hl=zh-CN&oi=sra)
...
======
* Gravitational Wave from Graviton Production: from the Early Universe to Stars
...
* Inflation and Its aftermath: Physics of (p)reheating, DM production and Mechanism of Baryogenesis <!-- Modular Symmetry and Its application -->
* Axion Cosmology
...
---
* In [2605.16201](https://arxiv.org/abs/2605.16201), we promoted the soft graviton theorem at scattering amplitude  level to cosmological level.
* We predicted the maximum GW amplitude from perturbative reheating as
...
* We demonstrated that future X-ray experiments can be used to probe inflationary reheating.
...
A simple way to realize cosmic inflation 
--
